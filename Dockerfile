...
RUN --mount=type=cache,id=s/a2a8bdf5-3a61-4f1d-877e-90fa97f05059-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store \
...
RUN --mount=type=cache,id=s/a2a8bdf5-3a61-4f1d-877e-90fa97f05059-/var/cache/apt,target=/var/cache/apt \
    --mount=type=cache,id=s/a2a8bdf5-3a61-4f1d-877e-90fa97f05059-/var/lib/apt,target=/var/lib/apt \
    apt-get update && \
